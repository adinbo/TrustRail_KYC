...
export class InHouseBiometricEngine {
     ...
     */
    generateFaceEmbedding(imagePayload, salt) {
     ...
     */
    evaluateLiveness(selfiePayload) {
        const flags = [];
     ...
     */
    async compareFaces(idPhotoPayload, selfiePayload, customThreshold) {
        ...
        if (idPhoto.toLowerCase().includes("mismatch") ||
